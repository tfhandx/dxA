...
class Advanced extends Component<
  { loading: boolean; userlistAndadvanced: AdvancedProfileData; dispatch: Dispatch<any> },
  AdvancedState
  > {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'userlistAndadvanced/fetchAdvanced',
    });
  }
  ...
  render() {
    ...
    const { userlistAndadvanced, loading } = this.props;
    const { advancedOperation1, advancedOperation2, advancedOperation3 } = userlistAndadvanced;
    const contentList = {
      tab1: (
        <Table
          pagination={false}
        ...
        <div className={styles.main}>
          <GridContent>
            ...
            <Card title="用户信息" style={{ marginBottom: 24 }} bordered={false}>
              <Descriptions layout="vertical" style={{ marginBottom: 24 }}>
              ...
              <Descriptions layout="vertical" style={{ marginBottom: 24 }} title="信息组">
...
export default connect(
  ({
    ...
    userlistAndadvanced: AdvancedProfileData;
    loading: {
      effects: { [key: string]: boolean };
    };
  }) => ({
    userlistAndadvanced,
    loading: loading.effects['userlistAndadvanced/fetchAdvanced'],
  }),
)(Advanced);
